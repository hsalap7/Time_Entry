...
<body>
  <header>
    ...
    <h2 style="color:#000066"><b>Welcome Admin</b>
    <div class="dropdown">
    ...
    <div >
      ...
      <button class="button b1" onclick="window.location.href='/TMS/jsp/timesheet.jsp'"><b>TIMESHEET</b></button>
...
<% } %>
  ...
  <form method="post" action="http://localhost:8092/TMS/AddTimeServlet" role="form" style="background-color:white"><input type="hidden" name="url" value="jsp/timesheet.jsp">
    <tr>
